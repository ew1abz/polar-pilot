...
async fn main(spawner: Spawner) -> ! {
    ...
    let mut el_pwm =
        SimplePwm::new(p.TIM2, Some(el_step), None, None, None, Hertz(1_000), Default::default());
    {
    ...
    let mut az_pwm =
        SimplePwm::new(p.TIM1, Some(az_step), None, None, None, Hertz(500), Default::default());
    {
